/**
 * Helpers de formatação monetária. Source-of-truth pra evitar o anti-
 * pattern `R$ ${v.toFixed(2)}` (que renderiza "R$ 0.00" com ponto US em
 * vez de "R$ 0,00" com vírgula BR — bug F#58 do E2E PRD 2026-05-25).
 *
 * Atualmente foca em BRL/pt-BR. Quando for adicionar suporte a outras
 * moedas/locales, evolui pra `formatCurrency(value, currency, locale)`
