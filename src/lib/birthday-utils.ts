...
// Fonte de verdade: tabela children. Não há tabela própria.
...
/**
 * Gera todas as ocorrências de aniversário dentro de um range [start, end] (inclusivo),
 * formatadas como YYYY-MM-DD. Itera por ano para cobrir ranges que cruzam virada de ano.
 */
export function getBirthdayOccurrences(
  birthDate: string,
  rangeStart: string,
  rangeEnd: string
): string[] {
