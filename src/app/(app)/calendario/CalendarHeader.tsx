    ...
    <div className="flex items-center justify-between">
      ...
      {!isReadonly && (
        <div className="flex items-center gap-2">
          ...
          {/* Bug Amanda 2026-05-14: novo botão ✈️ → /calendario/ferias.
              Mantém o + reservado pra Novo Evento (eventos sociais). Férias
              vai pro fluxo dedicado que cria custody_events vacation,
              sobrepondo a escala regular. */}
          <Link
            href="/calendario/ferias"
            className="w-9 h-9 flex items-center justify-center rounded-xl bg-white border border-gray-200/80 text-[#7A8C8B] hover:bg-gray-50 hover:text-[#2C2C2C] transition-all active:scale-95 shadow-sm"
            aria-label="Adicionar período de férias"
