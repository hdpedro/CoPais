...
function section2() {
  return [
    ...
    boldBullet("Server Actions", "73 acoes distribuidas em 23 arquivos para mutacoes seguras"),
    emptyLine(),
    heading2("2.2 Backend (Supabase)"),
    boldBullet("PostgreSQL 15", "banco relacional com 35+ tabelas e Row Level Security (RLS)"),
...
function section3() {
  const modules = [
    ["1. Calendario de Guarda", "custody_events, custody_schedules, swap_requests", "generateSchedule, createSwapRequest, respondToSwapRequest", "/calendario, /calendario/escala"],
    ["2. Atividades", "child_activities, activity_reports, checklist_completions", "createActivity, deleteActivity, submitActivityReport", "/atividades, /atividades/nova"],
    ...
    ["5. Saude", "appointments, medications, allergies, vaccines, dose_records, illnesses, growth_records, health_professionals, health_views (10 tabelas)", "createAppointment, createMedication, createAllergy, createVaccine, confirmDose, createIllness, createGrowthRecord + 9 mais", "/saude/*"],
  ...
  return [
    ...
    bullet("Vacinas com calendario SBP integrado e confirmacao de doses"),
    bullet("Consultas com agendamento WhatsApp e registro de retornos"),
    bullet("Medicamentos com posologia e lembretes"),
    bullet("Alergias com niveis de severidade"),
    ...
    emptyLine(),
    heading3("Chat"),
    body("Sistema de mensagens em tempo real com canais tematicos (geral, saude, financeiro, escola). Mensagens sao imutaveis para compliance legal em disputas de guarda. Inclui indicadores de leitura e notificacoes push."),
    emptyLine(),
    heading3("Despesas e Financeiro"),
    body("Divisao de despesas estilo Splitwise com upload de comprovantes, ratios de divisao configuraveis (50/50, 60/40, etc), sistema de acertos (settlements) e dashboard financeiro com graficos de gastos por categoria."),
    pageBreak(),
  ];
}
...
function section4() {
  const tables = [
    ...
    ["child_activities", "id, group_id, child_id, name, type, days, time, location, responsible", "Atividades das criancas"],
    ["activity_reports", "id, activity_id, date, attended, notes, checklist_data", "Relatorios de atividades"],
  ...
  return [
    ...
    body("O projeto possui 28 migrations sequenciais (00001 a 00028) que criam e evoluem o schema do banco. Cada migration e idempotente e pode ser aplicada via Supabase CLI ou manualmente no SQL Editor."),
    pageBreak(),
  ];
}
...
function section5() {
  return [
    ...
    emptyLine(),
    heading3("Camada 1: Parser Local (0ms de latencia)"),
    body("Um parser baseado em regex e heuristicas que identifica padroes comuns em portugues. Processa comandos como:"),
    ...
    body("O Groq oferece um tier gratuito generoso. Com o parser local resolvendo ~70% das requisicoes, o custo projetado e:"),
...
function section7() {
  return [
    ...
    boldBullet("Sanitizacao", "protecao contra XSS e SQL Injection via Supabase client"),
...
function section8() {
  return [
    ...
    emptyLine(),
    heading2("8.4 Otimizacoes Implementadas"),
    ...
    bullet("Lazy loading de modulos e locales de i18n"),
...
function section9() {
  return [
    ...
    body("O Kindar suporta 5 idiomas com 1.306 chaves de traducao, permitindo expansao para mercados internacionais."),
    emptyLine(),
