  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] text-[#0E0C0A]">
      ...
      <main>
        ...
        {/* ═══ WHATSAPP IA ═══ */}
        <section className="py-20 sm:py-28 px-5 sm:px-8 bg-[#25D366]/[0.06]">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-14">
              <div className="inline-flex items-center gap-2 mb-5 px-4 py-2 bg-[#25D366]/15 text-[#128C7E] text-xs font-bold rounded-full uppercase tracking-wider">
              ...
              <p className="mt-4 text-lg text-[#9A8878] max-w-2xl mx-auto">
                Mande uma mensagem como voce ja faz no dia a dia. O Kindar entende, organiza e salva tudo automaticamente.
              </p>
            </div>

            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto mb-12">
              {[
                { icon: "🎙️", title: "Mande audio ou texto", desc: "\"Gastei 50 com remedio do Lucas\" — o Kindar entende e registra a despesa automaticamente." },
                { icon: "📸", title: "Envie foto do recibo", desc: "Tire foto da nota fiscal. O Kindar extrai valor, descricao e categoria com inteligencia artificial." },
                { icon: "📅", title: "Agende pelo WhatsApp", desc: "\"Marca dentista do Lucas dia 15 as 10h\" — consulta agendada no calendario da familia." },
                { icon: "💰", title: "Registre despesas", desc: "Diga o valor e a descricao. O Kindar classifica, divide e notifica o outro responsavel." },
                { icon: "📊", title: "Consulte informacoes", desc: "\"Quanto gastamos esse mes?\" — resumo financeiro instantaneo, sem abrir o app." },
                { icon: "✅", title: "Confirmacao inteligente", desc: "Antes de registrar, o Kindar confirma com voce via botoes interativos. Nada e salvo sem sua aprovacao." },
              ].map(f => (
                <div key={f.title} className="p-5 rounded-2xl bg-white border border-[#25D366]/15 hover:border-[#25D366]/30 hover:shadow-md transition-all duration-200">
                  <span className="text-2xl">{f.icon}</span>
                  <h3 className="text-[14px] font-bold text-[#0E0C0A] mt-3 mb-1">{f.title}</h3>
                  <p className="text-[13px] text-[#9A8878] leading-relaxed">{f.desc}</p>
                </div>
            ...
            <div className="text-center">
              <a
                ...
                className="inline-flex items-center justify-center gap-3 bg-[#25D366] text-white text-lg font-semibold px-8 py-4 rounded-xl hover:bg-[#20BD5A] transition-all shadow-lg shadow-[#25D366]/20 hover:shadow-xl hover:-translate-y-0.5 active:scale-[0.98]"
              >
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                Falar com o Kindar no WhatsApp
              </a>
              <p className="mt-4 text-sm text-[#9A8878]">
                Funciona com qualquer celular. Basta ter WhatsApp.
              </p>
            </div>
          </div>
        </section>
