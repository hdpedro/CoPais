...
const OPTIONS: Option[] = [
  {
    ...
    description: "Gera saldo: você pega o dia agora e devolve outro depois",
  ...
  },
  {
    ...
    description: "Troca amigável, sem criar dívida",
  ...
  },
  {
    ...
    description: "Você cede este dia sem cobrar nada",
    needsProposedDate: false,
    needsDays: false,
  },
  {
    ...
    description: "Perdoa parte da dívida acumulada",
    needsProposedDate: false,
    needsDays: true,
  },
  {
    type: "reset_balance",
    icon: "🧹",
    label: "Zerar pendências",
    description: "Recomeçar do zero. Ambos precisam aprovar.",
    needsProposedDate: false,
    needsDays: false,
  },
];
