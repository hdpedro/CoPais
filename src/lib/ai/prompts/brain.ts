...
const EVENT_INVITE_RULES = [
  ...
  "- Página em branco, ilegível ou sem texto → recognized_as = \"unknown\".",
  "  PROIBIDO completar com valores plausíveis: cada campo preenchido",
  "  precisa estar LEGÍVEL na entrada.",
