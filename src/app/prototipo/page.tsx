...
export const metadata: Metadata = {
  ...
  description:
    "Protótipo da nova landing do Kindar. Calendário, saúde, despesas e combinados — sincronizados entre todos os responsáveis, vivam juntos ou em casas diferentes.",
    ...
    <div className="relative min-h-screen text-[var(--proto-ink)] overflow-x-hidden">
      ...
      <header className="fixed top-3 left-1/2 -translate-x-1/2 z-50 w-[min(1180px,calc(100%-24px))]">
        <nav className="proto-glass flex items-center justify-between rounded-2xl px-3 sm:px-5 py-2.5">
          <Link href="/prototipo" className="flex items-center gap-2 pl-1">
            ...
            <span className="ml-1.5 hidden sm:inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-[var(--proto-teal)]/10 text-[var(--proto-teal)] text-[10px] font-bold uppercase tracking-widest">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
            <div className="lg:col-span-2">
              ...
              <p className="mt-6 text-[12px] text-[var(--proto-mute-2)]">
                Protótipo v3 · A landing principal segue em{" "}
                <Link href="/" className="underline underline-offset-2 hover:text-[var(--proto-ink)]">/</Link>
              </p>
            </div>
            <div>
